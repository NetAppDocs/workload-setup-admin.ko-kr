...
| 역할에서 사용 가능한 사용 권한을 확인하고 필요한 사용 권한과 비교합니다 | IAM: SimulatePrincipalPolicy(IAM: 시뮬레이션 정책) | 구축 | 자동화 
|===
...
.3+| AI 엔진에 대한 SSM 연결을 점검하십시오 | SSM: SendCommand 를 참조하십시오 | 구축 | 자동화 


| SSM: GetConnectionStatus 를 참조하십시오 | 구축 | 자동화 


| SSM: SendCommand 를 참조하십시오 | 구축 | 자동화 
...
| 기초 모델에 대한 액세스 권한을 확인합니다 | Bedrock: GetFoundationModelAvailability를 참조하십시오 | 문제 해결 | 자동화 
|===
====
...
.4+| KMS 키 세부 정보를 확인하고 Amazon FSx for NetApp ONTAP 암호화에 사용합니다 | KMS: CreateGrant | 구축 | 자동화 
