...
| 기반 모델에 대한 정보 확인 | Bedrock: GetFoundationModel 을 참조하십시오 | 구축 | 자동화 
...
이제 데이터베이스에 대해 _READ_MODE에서 다음 권한을 사용할 수 `iam:SimulatePrincipalPolicy` 있습니다. 이제 GenAI에 대해 _AUTOMATE_MODE에서 다음 권한을 사용할 수 `bedrock:GetFoundationModel` 있습니다.
