...
---
= NetApp Workload Factory의 워크로드 기능
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* https://docs.netapp.com/us-en/workload-eda/index.html["EDA 워크로드"^]
+
자동화된 스토리지 파라미터 관리를 통해 여러 파일 시스템에서 ONTAP 에 맞게 FSx를 최적화하여 성능을 향상시키고 운영 비용을 절감하십시오.
