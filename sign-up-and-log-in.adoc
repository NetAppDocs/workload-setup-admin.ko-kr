...
---
= NetApp Workload Factory에 가입하고 로그인합니다.
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
NOTE: Workload Factory의 AI 기능은 AWS 퍼블릭 리전에 호스팅된 AWS Bedrock 서비스를 사용합니다. 보안 정책에서 퍼블릭 리전 서비스에 대한 연결을 허용하지 않는 경우 관리 설정에서 AI 기능을 비활성화할 수 있습니다. link:manage-genai-features.html["AI 기능 관리에 대해 알아보기"].
