...
| 복제 지연 | 복제에 예상보다 시간이 오래 걸리고 있습니다. | 복제 | 비판적인 | 일반 보관 | ONTAP 파일 시스템용 FSx 


| 사용자 지정 대시보드 생성이 완료되었습니다. | 사용자 지정 대시보드가 성공적으로 생성되었으며, 이제 확인하실 수 있습니다. | 맞춤형 대시보드 | 성공 | 일반 보관 | 워크로드 팩토리 계정 


| 사용자 지정 대시보드 생성 실패 | Workload Factory에서 사용자 지정 대시보드를 생성할 수 없습니다. 대시보드를 다시 생성해 보세요. | 맞춤형 대시보드 | 오류 | 일반 보관 | 워크로드 팩토리 계정 
|===
