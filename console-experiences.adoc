...
---
= NetApp Workload Factory 용 콘솔 환경
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
NetApp Console 에서 Workload Factory에 액세스할 수 있습니다. AWS 스토리지 및 워크로드 기능에 Workload Factory를 사용하는 것 외에도 NetApp Copy and Sync 등의 다른 데이터 서비스에도 액세스할 수 있습니다.
